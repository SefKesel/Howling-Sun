...
import sefkesel.howlingsun.networking.packet.HowlingXPC2SPacket;
import sefkesel.howlingsun.networking.packet.HowlingXPS2CPacket;
...
public class ModPackets {
    ...
    public static void registerC2SPackets(){ // Registrar los paquetes del cliente al servidor (Sucede en el servidor)
        ServerPlayNetworking.registerGlobalReceiver(MENU_ID, HowlingXPC2SPacket::receive);
    }
    public static void registerS2CPackets(){ // Registrar los paquetes del servidor al cliente (Sucede en el cliente)
        ClientPlayNetworking.registerGlobalReceiver(MENUS2C_ID, HowlingXPS2CPacket::receive);
    }
}
